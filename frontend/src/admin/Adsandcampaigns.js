        ...
        <div className="sidebar-menu">
          <nav>
            <ul>
              ...
              <li>
                <div
                  className={`menu-item ${activeMenu === "광고&캠페인" ? "active" : ""}`}
                  onClick={() => handleMenuClick("광고&캠페인")}
                >
                  <img src="/icon/Group 27.png" alt="회원 문의 아이콘" className="menu-icon" /> 광고&캠페인
                </div>
                {activeMenu === "광고&캠페인" && (
                  <ul className="submenu">
                    <li
                      className={`submenu-item ${activeSubmenu === "공고 광고 관리" ? "active" : ""}`}
                      onClick={() => {
                        handleSubmenuClick("공고 광고 관리");
                        navigateTo("/admin/adsList");
                      }}
                    >
                      공고 광고 관리
                    </li>
                    <li
                      className={`submenu-item ${activeSubmenu === "공고 광고 추가" ? "active" : ""}`}
                      onClick={() => {
                        handleSubmenuClick("공고 광고 추가");
                        navigateTo("/admin/addAds");
                      }}
                    >
                      공고 광고 추가
                    </li>
